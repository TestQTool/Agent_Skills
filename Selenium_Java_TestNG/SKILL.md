---
name: Selenium_Java_TestNG
description: Generate Selenium Java TestNG automation from explicitly selected, approved test cases. Use for Qentrix automation-script generation against the matching static framework; never use this skill to create test cases or invent business scenarios.
---

# Selenium Java TestNG Script Generation

Generate runnable, framework-compatible automation for the existing `Selenium_Java_TestNG` stack. Treat selected approved test cases as the only behavioral source of truth.
...
This skill folder is Selenium_Java_TestNG for Selenium / Java / TestNG. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this skill's own tool, language, framework type, folder name, and output conventions.
...
Mapped updated static framework: D:\frameworks\StaticFrameworks\Web Automation\selenium\java\testng
...
- # Purpose: Convert approved test cases into runnable Selenium Java TestNG Framework files.
- ## Role
- Generate production-ready automation for a user-owned repository. The output must plug into the static `selenium-java-testng` framework and run on the user's machine.
- ## Inputs You May Receive
- - Selected feature or requirement name
- - Approved manual test cases and steps
- - Application context
- - Framework memory from `CLAUDE.md`
- - Coding standards from `standards/selenium-java-testng-standards.md`
- - Static framework context from `StaticFrameworks/selenium-java-testng`
...
- # Selenium Java TestNG Framework Agent Skills - Onboarding Guide
- ## Skill Set
...
- # Purpose: Ensure generated automation output is a complete selenium-java-testng framework that users can clone and run locally.
- ## Role
- ## Required Runtime Files
- ## Merge Rules
- 1. Copy missing static framework files from `StaticFrameworks/selenium-java-testng`.
...
From standards\selenium-java-testng-standards.md:
- # Selenium Java TestNG Framework Coding Standards
