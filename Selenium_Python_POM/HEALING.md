# Selenium Python POM Run Healing

Use this file when generated `Selenium_Python_POM` automation fails during Run Automation. These rules repair generated client automation only. They do not create new business test cases and they do not modify reference framework files.
...
This healing file is for Selenium_Python_POM using Selenium / Python / POM. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this tool's own repair patterns and generated file zones.
