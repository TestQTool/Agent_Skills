...
{
  "files": [
    { "path": "webdriverio-cucumber-bdd/test/pageobjects/<feature>.selectors.ts", "content": "..." },
    { "path": "webdriverio-cucumber-bdd/test/pageobjects/<feature>.page.ts", "content": "..." },
    { "path": "webdriverio-cucumber-bdd/features/step-definitions/<feature>.steps.ts", "content": "..." },
    { "path": "webdriverio-cucumber-bdd/package.json", "content": "..." },
    { "path": "webdriverio-cucumber-bdd/wdio.conf.ts", "content": "..." }
  ],
  "notes": []
}
```
...
3. `features/step-definitions/<feature>.steps.ts`: test orchestration using page/keyword methods only.
...
- Paths start with `webdriverio-cucumber-bdd/`.
