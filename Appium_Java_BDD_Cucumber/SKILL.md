---
name: appium-java-bdd-cucumber
description: Generate, explore, heal, review, and package mobile automation for Appium + Java + BDD Cucumber with Android and iOS support. Use when Codex needs to create a production-ready appium-java-bdd-cucumber framework, convert mobile test cases into automated tests, discover Android/iOS locators, repair broken selectors, or validate device-ready execution.
---

# Appium Java BDD Cucumber Mobile Skill
...
4. `standards/appium-java-bdd-cucumber-standards.md`
