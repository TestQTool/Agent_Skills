...
Skill folder: WebdriverIO_JS_Cucumber_BDD
Domain: Web Automation
Tool: WebdriverIO
Language: Unspecified
Framework type: BDD Cucumber
...
## Mapped Static Framework

- Path: D:\frameworks\StaticFrameworks\Web Automation\webdriverio\javascript\cucumber-bdd
- Run command: npx wdio run wdio.conf.js
- Test pattern: features/**/*.feature

This mapped static framework is the path and runner source of truth for this skill. The Playwright JavaScript Hybrid skill remains a quality reference only.
