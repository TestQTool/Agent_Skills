---
name: explore
description: Explore API automation for RestAssured Java TestNG automation by capturing selectors, endpoints, screen/API evidence, assertions, test data, and gaps.
---
