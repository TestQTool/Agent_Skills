---
name: Appium_WebdriverIO_TypeScript
...
Generate runnable, framework-compatible automation for the existing `Appium_WebdriverIO_TypeScript` stack. Treat selected approved test cases as the only behavioral source of truth.
