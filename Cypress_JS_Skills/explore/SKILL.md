---
name: explore
description: Explore a live web application module/page and produce screenshots, DOM notes, UI flows, selector evidence, assertion targets, data dependencies, and gaps for downstream test-case generation and Cypress JavaScript automation.
---
