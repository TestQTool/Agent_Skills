---
name: appium-webdriverio-typescript
description: Generate, explore, heal, review, and package mobile automation for Appium + TypeScript + WebdriverIO Framework with Android and iOS support. Use when Codex needs to create a production-ready appium-webdriverio-typescript framework, convert mobile test cases into automated tests, discover Android/iOS locators, repair broken selectors, or validate device-ready execution.
---

# Appium TypeScript WebdriverIO Framework Mobile Skill
...
4. `standards/appium-webdriverio-typescript-standards.md`
