---
name: appium-csharp-bdd
description: Generate, explore, heal, review, and package mobile automation for Appium + C# + BDD Framework with Android and iOS support. Use when Codex needs to create a production-ready appium-csharp-bdd framework, convert mobile test cases into automated tests, discover Android/iOS locators, repair broken selectors, or validate device-ready execution.
---

# Appium C# BDD Framework Mobile Skill
...
4. `standards/appium-csharp-bdd-standards.md`
