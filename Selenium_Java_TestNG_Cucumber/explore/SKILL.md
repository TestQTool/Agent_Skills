---
name: explore
description: Explore web UI automation for Selenium Java TestNG automation by capturing selectors, endpoints, screen/API evidence, assertions, test data, and gaps.
---
