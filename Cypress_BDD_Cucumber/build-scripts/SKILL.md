...
{
  "files": [
    { "path": "cypress-bdd-cucumber/cypress/pageObjects/<feature>PageObjects.ts", "content": "..." },
    { "path": "cypress-bdd-cucumber/cypress/pages/<feature>Page.ts", "content": "..." },
    { "path": "cypress-bdd-cucumber/cypress/e2e/step_definitions/<feature>Steps.ts", "content": "..." },
    { "path": "cypress-bdd-cucumber/package.json", "content": "..." },
    { "path": "cypress-bdd-cucumber/cypress.config.ts", "content": "..." }
  ],
  "notes": []
}
```
...
1. `cypress/pageObjects/<feature>PageObjects.ts`: selectors/locators only.
2. `cypress/pages/<feature>Page.ts`: page actions, waits, data access, and assertions.
3. `cypress/e2e/step_definitions/<feature>Steps.ts`: test orchestration using page/keyword methods only.
...
- Paths start with `cypress-bdd-cucumber/`.
