...
{
  "files": [
    { "path": "playwright-typescript/pageObjects/<feature>PageObjects.ts", "content": "..." },
    { "path": "playwright-typescript/pages/<feature>Page.ts", "content": "..." },
    { "path": "playwright-typescript/tests/<Feature>.spec.ts", "content": "..." },
    { "path": "playwright-typescript/package.json", "content": "..." },
    { "path": "playwright-typescript/playwright.config.ts", "content": "..." }
  ],
  "notes": []
}
```
...
3. `tests/<Feature>.spec.ts`: test orchestration using page/keyword methods only.
...
- Paths start with `playwright-typescript/`.
