# RobotFramework Python Appiumlibrary Run Healing

Use this file when generated `RobotFramework_Python_AppiumLibrary` automation fails during Run Automation. These rules repair generated client automation only. They do not create new business test cases and they do not modify reference framework files.
...
- Language is `Python`.
- Framework type is `Appiumlibrary`.
...
This healing file is for RobotFramework_Python_AppiumLibrary using Robot Framework / Unspecified / AppiumLibrary. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this tool's own repair patterns and generated file zones.
