# Appium Java TestNG Run Healing

Use this file when generated `Appium_Java_TestNG` automation fails during Run Automation. These rules repair generated client automation only. They do not create new business test cases and they do not modify reference framework files.
...
This healing file is for Appium_Java_TestNG using Appium / Java / TestNG. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this tool's own repair patterns and generated file zones.
