---
name: Selenium_Java_POM
description: Generate Selenium Java POM automation from explicitly selected, approved test cases. Use for Qentrix automation-script generation against the matching static framework; never use this skill to create test cases or invent business scenarios.
---

# Selenium Java POM Script Generation

Generate runnable, framework-compatible automation for the existing `Selenium_Java_POM` stack. Treat selected approved test cases as the only behavioral source of truth.
...
This skill folder is Selenium_Java_POM for Selenium / Java / POM. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this skill's own tool, language, framework type, folder name, and output conventions.
...
Mapped updated static framework: D:\frameworks\StaticFrameworks\Web Automation\selenium\java\pom
...
- # Selenium Java Page Object Model Framework Agent Skills - Onboarding Guide
- ## Skill Set
- ## Recommended Read Order
- 1. `CLAUDE.md`
- 2. `docs/onboarding-guide.md`
- 3. `docs/app-context.md`
- 4. `standards/selenium-java-pom-standards.md`
- 5. `build-scripts/SKILL.md`
- 6. `run-ready-framework/SKILL.md`
- 7. GitHub workflow skill, when repository operations are required
- 8. Static framework files from `StaticFrameworks/selenium-java-pom`
...
- # Purpose: Ensure generated automation output is a complete selenium-java-pom framework that users can clone and run locally.
- ## Role
- ## Required Runtime Files
- ## Merge Rules
- 1. Copy missing static framework files from `StaticFrameworks/selenium-java-pom`.
...
From standards\selenium-java-pom-standards.md:
- # Selenium Java Page Object Model Framework Coding Standards
...
From CLAUDE.md:
- # QA Automation - Selenium Java Page Object Model Framework Project Memory
- ## Goal
- Generate a self-contained `selenium-java-pom` web automation framework that a user can clone, install, configure, and run locally or in CI.
- ## Runtime Layout
