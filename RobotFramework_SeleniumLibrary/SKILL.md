...
description: Generate, explore, heal, review, and package web automation assets for Robot Framework + Robot + Selenium Library. Use when Codex needs to create or maintain a production-ready robotframework-seleniumlibrary framework, convert approved manual test cases into automated tests, discover selectors, repair broken locators, or validate clone-and-run readiness for this stack.
---

# Robot Framework Robot Selenium Library Skill

## Purpose

Use this skill package to create production-ready web automation for the Robot Framework + Robot + Selenium Library stack. The generated repository must be self-contained and runnable on a user machine without depending on Agent_Skills, prompt files, or StaticFrameworks at runtime.
...
4. `standards/robotframework-seleniumlibrary-standards.md` for coding and folder conventions.
