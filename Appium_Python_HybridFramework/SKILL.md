---
name: appium-python-hybridframework
description: Generate, explore, heal, review, and package mobile automation for Appium + Python + Hybrid Framework with Android and iOS support. Use when Codex needs to create a production-ready appium-python-hybrid framework, convert mobile test cases into automated tests, discover Android/iOS locators, repair broken selectors, or validate device-ready execution.
---

# Appium Python Hybrid Framework Mobile Skill
...
4. `standards/appium-python-hybrid-standards.md`
