...
{
  "files": [
    { "path": "selenium-java-junit/src/main/java/pageObjects/<Feature>PageObjects.java", "content": "..." },
    { "path": "selenium-java-junit/src/main/java/pages/<Feature>Page.java", "content": "..." },
    { "path": "selenium-java-junit/src/test/java/tests/<Feature>Test.java", "content": "..." },
    { "path": "selenium-java-junit/pom.xml", "content": "..." },
    { "path": "selenium-java-junit/src/test/resources/config.properties", "content": "..." }
  ],
  "notes": []
}
```
...
- Paths start with `selenium-java-junit/`.
