---
name: Playwright_Python_Standard
description: Generate Playwright Python Standard automation from explicitly selected, approved test cases. Use for Qentrix automation-script generation against the matching static framework; never use this skill to create test cases or invent business scenarios.
---

# Playwright Python Standard Script Generation

Generate runnable, framework-compatible automation for the existing `Playwright_Python_Standard` stack. Treat selected approved test cases as the only behavioral source of truth.
...
This skill folder is Playwright_Python_Standard for Playwright / Python / Standard. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this skill's own tool, language, framework type, folder name, and output conventions.
...
- # Purpose: Ensure generated automation output is a complete playwright-python framework that users can clone and run locally.
- ## Role
- ## Required Runtime Files
- ## Merge Rules
- 1. Copy missing static framework files from `StaticFrameworks/playwright-python`.
...
From standards\playwright-python-standards.md:
- # Playwright Python Framework Coding Standards
...
From CLAUDE.md:
- # QA Automation - Playwright Python Framework Project Memory
- ## Goal
- Generate a self-contained `playwright-python` web automation framework that a user can clone, install, configure, and run locally or in CI.
- ## Runtime Layout
