...
{
  "files": [
    { "path": "playwright-bdd-cucumber/pageObjects/<feature>PageObjects.ts", "content": "..." },
    { "path": "playwright-bdd-cucumber/pages/<feature>Page.ts", "content": "..." },
    { "path": "playwright-bdd-cucumber/step-definitions/<feature>Steps.ts", "content": "..." },
    { "path": "playwright-bdd-cucumber/package.json", "content": "..." },
    { "path": "playwright-bdd-cucumber/cucumber.js", "content": "..." }
  ],
  "notes": []
}
```
...
1. `pageObjects/<feature>PageObjects.ts`: selectors/locators only.
2. `pages/<feature>Page.ts`: page actions, waits, data access, and assertions.
3. `step-definitions/<feature>Steps.ts`: test orchestration using page/keyword methods only.
...
- Paths start with `playwright-bdd-cucumber/`.
