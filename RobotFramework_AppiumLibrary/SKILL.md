---
name: RobotFramework_AppiumLibrary
...
Generate runnable, framework-compatible automation for the existing `RobotFramework_AppiumLibrary` stack. Treat selected approved test cases as the only behavioral source of truth.
