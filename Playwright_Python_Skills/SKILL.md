---
name: playwright-python-skills
description: Generate, explore, heal, review, and package web automation assets for Playwright + Python + Framework. Use when Codex needs to create or maintain a production-ready playwright-python framework, convert approved manual test cases into automated tests, discover selectors, repair broken locators, or validate clone-and-run readiness for this stack.
---

# Playwright Python Framework Skill

## Purpose

Use this skill package to create production-ready web automation for the Playwright + Python + Framework stack. The generated repository must be self-contained and runnable on a user machine without depending on Agent_Skills, prompt files, or StaticFrameworks at runtime.
...
4. `standards/playwright-python-standards.md` for coding and folder conventions.
