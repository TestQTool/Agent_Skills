---
name: RobotFramework_SeleniumLibrary
...
Generate runnable, framework-compatible automation for the existing `RobotFramework_SeleniumLibrary` stack. Treat selected approved test cases as the only behavioral source of truth.
