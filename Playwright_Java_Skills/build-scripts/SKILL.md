...
{
  "files": [
    { "path": "playwright-java/src/main/java/pageobjects/<Feature>PageObjects.java", "content": "..." },
    { "path": "playwright-java/src/main/java/pages/<Feature>Page.java", "content": "..." },
    { "path": "playwright-java/src/test/java/tests/<Feature>Test.java", "content": "..." },
    { "path": "playwright-java/pom.xml", "content": "..." },
    { "path": "playwright-java/src/test/resources/config.properties", "content": "..." }
  ],
  "notes": []
}
```
...
- Paths start with `playwright-java/`.
