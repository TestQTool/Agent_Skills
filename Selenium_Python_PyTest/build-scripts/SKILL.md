...
{
  "files": [
    { "path": "selenium-python-pytest/page_objects/<feature>_page_objects.py", "content": "..." },
    { "path": "selenium-python-pytest/pages/<feature>_page.py", "content": "..." },
    { "path": "selenium-python-pytest/tests/test_<feature>.py", "content": "..." },
    { "path": "selenium-python-pytest/requirements.txt", "content": "..." },
    { "path": "selenium-python-pytest/config/config.yaml", "content": "..." }
  ],
  "notes": []
}
```
...
- Paths start with `selenium-python-pytest/`.
