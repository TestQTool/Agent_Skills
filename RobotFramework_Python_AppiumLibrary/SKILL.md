---
name: RobotFramework_Python_AppiumLibrary
description: Generate RobotFramework Python Appiumlibrary automation from explicitly selected, approved test cases. Use for Qentrix automation-script generation against the matching static framework; never use this skill to create test cases or invent business scenarios.
---

# RobotFramework Python Appiumlibrary Script Generation

Generate runnable, framework-compatible automation for the existing `RobotFramework_Python_AppiumLibrary` stack. Treat selected approved test cases as the only behavioral source of truth.
...
This skill folder is RobotFramework_Python_AppiumLibrary for Robot Framework / Unspecified / AppiumLibrary. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this skill's own tool, language, framework type, folder name, and output conventions.
...
- # Robot Framework Robot Appium Library Mobile Onboarding Guide
- ## Skill Set
...
From standards\robotframework-appiumlibrary-standards.md:
