...
Skill folder: RobotFramework_Python_CustomKeywords
Domain: Web Automation
Tool: Robot Framework
Language: Python
Framework type: Custom Keywords
...
- Path: D:\frameworks\StaticFrameworks\Web Automation\robotframework\python\custom-keywords
