---
name: WebdriverIO_TypeScript_Skills
...
Generate runnable, framework-compatible automation for the existing `WebdriverIO_TypeScript_Skills` stack. Treat selected approved test cases as the only behavioral source of truth.
