---
name: playwright-typescript-skills
description: Generate, explore, heal, review, and package web automation assets for Playwright + TypeScript + Framework. Use when Codex needs to create or maintain a production-ready playwright-typescript framework, convert approved manual test cases into automated tests, discover selectors, repair broken locators, or validate clone-and-run readiness for this stack.
---
...
Use this skill package to create production-ready web automation for the Playwright + TypeScript + Framework stack. The generated repository must be self-contained and runnable on a user machine without depending on Agent_Skills, prompt files, or StaticFrameworks at runtime.
...
4. `standards/playwright-typescript-standards.md` for coding and folder conventions.
