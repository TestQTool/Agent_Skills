...
{
  "files": [
    { "path": "selenium-java-testng/src/main/java/pageObjects/<Feature>PageObjects.java", "content": "..." },
    { "path": "selenium-java-testng/src/main/java/pages/<Feature>Page.java", "content": "..." },
    { "path": "selenium-java-testng/src/test/java/tests/<Feature>Test.java", "content": "..." },
    { "path": "selenium-java-testng/pom.xml", "content": "..." },
    { "path": "selenium-java-testng/src/test/resources/config.properties", "content": "..." }
  ],
  "notes": []
}
```
...
- Paths start with `selenium-java-testng/`.
