# Selenium Java JUnit Run Healing

Use this file when generated `Selenium_Java_JUnit` automation fails during Run Automation. These rules repair generated client automation only. They do not create new business test cases and they do not modify reference framework files.
...
This healing file is for Selenium_Java_JUnit using Selenium / Java / JUnit. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this tool's own repair patterns and generated file zones.
