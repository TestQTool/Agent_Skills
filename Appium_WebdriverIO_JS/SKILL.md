---
name: appium-webdriverio-js
description: Generate, explore, heal, review, and package mobile automation for Appium + JavaScript + WebdriverIO Framework with Android and iOS support. Use when Codex needs to create a production-ready appium-webdriverio-js framework, convert mobile test cases into automated tests, discover Android/iOS locators, repair broken selectors, or validate device-ready execution.
---

# Appium JavaScript WebdriverIO Framework Mobile Skill
...
4. `standards/appium-webdriverio-js-standards.md`
