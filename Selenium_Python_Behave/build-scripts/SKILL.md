...
{
  "files": [
    { "path": "selenium-python-behave/page_objects/<feature>_page_objects.py", "content": "..." },
    { "path": "selenium-python-behave/pages/<feature>_page.py", "content": "..." },
    { "path": "selenium-python-behave/features/steps/<feature>_steps.py", "content": "..." },
    { "path": "selenium-python-behave/requirements.txt", "content": "..." },
    { "path": "selenium-python-behave/behave.ini", "content": "..." }
  ],
  "notes": []
}
```
...
3. `features/steps/<feature>_steps.py`: test orchestration using page/keyword methods only.
...
- Paths start with `selenium-python-behave/`.
