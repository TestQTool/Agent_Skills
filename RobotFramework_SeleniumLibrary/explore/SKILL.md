---
name: explore
description: Explore a live web application module/page and produce screenshots, DOM notes, UI flows, selector evidence, assertion targets, data dependencies, and gaps for downstream test-case generation and Robot Framework Robot automation.
---
  ...
  "elements": [
    {
      ...
      "type": "button",
      "selectorCandidates": [],
      "recommendedSelector": "${LOGIN_BUTTON}    id:login",
