...
Generate runnable, framework-compatible automation for the existing `RestAssured_Prompt` stack. Treat selected approved test cases as the only behavioral source of truth.
