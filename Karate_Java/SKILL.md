...
Generate runnable, framework-compatible automation for the existing `Karate_Java` stack. Treat selected approved test cases as the only behavioral source of truth.
