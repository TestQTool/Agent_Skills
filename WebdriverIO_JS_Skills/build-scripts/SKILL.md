...
{
  "files": [
    { "path": "webdriverio-js/test/pageobjects/<feature>.selectors.js", "content": "..." },
    { "path": "webdriverio-js/test/pageobjects/<feature>.page.js", "content": "..." },
    { "path": "webdriverio-js/test/specs/<feature>.spec.js", "content": "..." },
    { "path": "webdriverio-js/package.json", "content": "..." },
    { "path": "webdriverio-js/wdio.conf.js", "content": "..." }
  ],
  "notes": []
}
```
...
1. `test/pageobjects/<feature>.selectors.js`: selectors/locators only.
2. `test/pageobjects/<feature>.page.js`: page actions, waits, data access, and assertions.
3. `test/specs/<feature>.spec.js`: test orchestration using page/keyword methods only.
...
- Paths start with `webdriverio-js/`.
