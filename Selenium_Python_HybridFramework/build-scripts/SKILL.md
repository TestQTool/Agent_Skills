...
{
  "files": [
    { "path": "selenium-python-hybrid/page_objects/<feature>_page_objects.py", "content": "..." },
    { "path": "selenium-python-hybrid/pages/<feature>_page.py", "content": "..." },
    { "path": "selenium-python-hybrid/tests/test_<feature>.py", "content": "..." },
    { "path": "selenium-python-hybrid/requirements.txt", "content": "..." },
    { "path": "selenium-python-hybrid/config/config.yaml", "content": "..." }
  ],
  "notes": []
}
```
...
- Paths start with `selenium-python-hybrid/`.
