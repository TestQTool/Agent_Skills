...
description: Generate, explore, heal, review, and package mobile automation for Robot Framework + Robot + Appium Library with Android and iOS support. Use when Codex needs to create a production-ready robotframework-appiumlibrary framework, convert mobile test cases into automated tests, discover Android/iOS locators, repair broken selectors, or validate device-ready execution.
---

# Robot Framework Robot Appium Library Mobile Skill
...
4. `standards/robotframework-appiumlibrary-standards.md`
