---
name: Playwright_JS_BDD_Cucumber
description: Generate Playwright General BDD Cucumber automation from explicitly selected, approved test cases. Use for Qentrix automation-script generation against the matching static framework; never use this skill to create test cases or invent business scenarios.
---

# Playwright General BDD Cucumber Script Generation

Generate runnable, framework-compatible automation for the existing `Playwright_JS_BDD_Cucumber` stack. Treat selected approved test cases as the only behavioral source of truth.
...
This skill folder is Playwright_JS_BDD_Cucumber for Playwright / Unspecified / BDD Cucumber. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this skill's own tool, language, framework type, folder name, and output conventions.
...
Mapped updated static framework: D:\frameworks\StaticFrameworks\Web Automation\playwright\javascript\bdd
...
- # Playwright JavaScript/TypeScript Build Scripts Skill
- # Purpose: Convert approved test cases into runnable Playwright JavaScript/TypeScript BDD Cucumber Framework files.
- ## Role
- Generate production-ready automation for a user-owned repository. The output must plug into the static `playwright-bdd-cucumber` framework and run on the user's machine.
- ## Inputs You May Receive
- - Selected feature or requirement name
- - Approved manual test cases and steps
- - Application context
- - Framework memory from `CLAUDE.md`
- - Coding standards from `standards/playwright-bdd-cucumber-standards.md`
- - Static framework context from `StaticFrameworks/playwright-bdd-cucumber`
...
- # Playwright JavaScript/TypeScript BDD Cucumber Framework Agent Skills - Onboarding Guide
- ## Skill Set
...
- 8. Static framework files from `StaticFrameworks/playwright-bdd-cucumber`
- 9. Approved test cases, exploration findings, and existing target repo files
- ## Expected User Outcome
- ## Repository Split

From explore\SKILL.md:
- # Playwright JavaScript/TypeScript Explore Skill
- ## Role
- ## Modes
- ### Module Discovery
...
- # Purpose: Ensure generated automation output is a complete playwright-bdd-cucumber framework that users can clone and run locally.
- ## Role
- ## Required Runtime Files
- ## Merge Rules
- 1. Copy missing static framework files from `StaticFrameworks/playwright-bdd-cucumber`.
...
From standards\playwright-bdd-cucumber-standards.md:
