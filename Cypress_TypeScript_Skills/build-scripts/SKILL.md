...
{
  "files": [
    { "path": "cypress-typescript/cypress/pageObjects/<feature>PageObjects.ts", "content": "..." },
    { "path": "cypress-typescript/cypress/pages/<feature>Page.ts", "content": "..." },
    { "path": "cypress-typescript/cypress/e2e/<feature>.cy.ts", "content": "..." },
    { "path": "cypress-typescript/package.json", "content": "..." },
    { "path": "cypress-typescript/cypress.config.ts", "content": "..." }
  ],
  "notes": []
}
```
...
3. `cypress/e2e/<feature>.cy.ts`: test orchestration using page/keyword methods only.
...
- Paths start with `cypress-typescript/`.
