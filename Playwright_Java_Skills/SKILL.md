...
Generate runnable, framework-compatible automation for the existing `Playwright_Java_Skills` stack. Treat selected approved test cases as the only behavioral source of truth.
