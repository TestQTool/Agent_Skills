---
name: explore
description: Explore web UI automation for Playwright Java TestNG automation by capturing selectors, endpoints, screen/API evidence, assertions, test data, and gaps.
---

# Explore Skill

Capture evidence for downstream TestNG automation. Do not generate final tests here.
