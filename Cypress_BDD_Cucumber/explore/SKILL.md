---
name: explore
description: Explore a live web application module/page and produce screenshots, DOM notes, UI flows, selector evidence, assertion targets, data dependencies, and gaps for downstream test-case generation and Cypress JavaScript/TypeScript automation.
---
  ...
  "elements": [
    {
      ...
      "type": "button",
      "selectorCandidates": [],
      "recommendedSelector": "export const loginButton = '[data-testid="login"]';",
