...
This skill is technology-aware only for downstream automation readiness: keep the test cases suitable for Selenium Python Hybrid/POM automation, but do not include Selenium locators, DOM structure, Python code, fixture names, or implementation details.
...
14. Do not include selectors, XPath, DOM structure, backend classes, API internals, database details, ADO API details, Jira API details, Zephyr API details, Selenium APIs, Python APIs, page object names, or pytest fixture names.
