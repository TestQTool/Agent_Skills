---
name: webdriverio-js-skills
description: Generate, explore, heal, review, and package web automation assets for WebdriverIO + JavaScript + Framework. Use when Codex needs to create or maintain a production-ready webdriverio-js framework, convert approved manual test cases into automated tests, discover selectors, repair broken locators, or validate clone-and-run readiness for this stack.
---

# WebdriverIO JavaScript Framework Skill

## Purpose

Use this skill package to create production-ready web automation for the WebdriverIO + JavaScript + Framework stack. The generated repository must be self-contained and runnable on a user machine without depending on Agent_Skills, prompt files, or StaticFrameworks at runtime.
...
4. `standards/webdriverio-js-standards.md` for coding and folder conventions.
