---
name: WebdriverIO_JS_Standard
description: Generate WebdriverIO JavaScript Standard automation from explicitly selected, approved test cases. Use for Qentrix automation-script generation against the matching static framework; never use this skill to create test cases or invent business scenarios.
---

# WebdriverIO JavaScript Standard Script Generation

Generate runnable, framework-compatible automation for the existing `WebdriverIO_JS_Standard` stack. Treat selected approved test cases as the only behavioral source of truth.
...
This skill folder is WebdriverIO_JS_Standard for WebdriverIO / JavaScript / Standard. Use updateagentskill/playwright/javascript/hybrid as a quality reference only; preserve this skill's own tool, language, framework type, folder name, and output conventions.
...
Mapped updated static framework: D:\frameworks\StaticFrameworks\Web Automation\webdriverio\javascript\standard
...
- # WebdriverIO JavaScript Build Scripts Skill
- # Purpose: Convert approved test cases into runnable WebdriverIO JavaScript Framework files.
- ## Role
- Generate production-ready automation for a user-owned repository. The output must plug into the static `webdriverio-js` framework and run on the user's machine.
- ## Inputs You May Receive
- - Selected feature or requirement name
- - Approved manual test cases and steps
- - Application context
- - Framework memory from `CLAUDE.md`
- - Coding standards from `standards/webdriverio-js-standards.md`
- - Static framework context from `StaticFrameworks/webdriverio-js`
...
- # WebdriverIO JavaScript Framework Agent Skills - Onboarding Guide
- ## Skill Set
...
- # Purpose: Ensure generated automation output is a complete webdriverio-js framework that users can clone and run locally.
- ## Role
- ## Required Runtime Files
- ## Merge Rules
- 1. Copy missing static framework files from `StaticFrameworks/webdriverio-js`.
...
From standards\webdriverio-js-standards.md:
- # WebdriverIO JavaScript Framework Coding Standards
