---
name: Appium_Python_HybridFramework
...
Generate runnable, framework-compatible automation for the existing `Appium_Python_HybridFramework` stack. Treat selected approved test cases as the only behavioral source of truth.
